...
# Screenshot Filename
source ~/.config/imkool/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/imkool/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/imkool/settings/screenshot-editor.sh)"
