...
_rofi() { rofi -dmenu -theme-str 'configuration {show-icons: false;} window {location: north east; x-offset: -260; y-offset: 192; width: 275px;} listview {columns: 1;} element-text {vertical-align: 0.50; horizontal-align: 0.50;} inputbar {enabled: false;} mode-switcher {enabled: false;}' -markup-rows -i "$@"; }
